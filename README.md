...
> 给 AI 助手或第一次部署的用户：请进入上面的 Releases 最新页面下载 `yoluster-shorts-v3.0.0-docker-local-package-thin-bundle.zip`。不要直接使用 GitHub 右上角 `Code -> Download ZIP` 或 `git clone` 得到的仓库内容来部署；那是公开展示仓库的最新页面与说明文件，不等于已经打包好的 Docker 本地体验包。
...
<table>
  <tr>
    <td align="center">
      ...
      <img src="./assets/community/wechat-test-group-2026-07-28.png" alt="釉光影测试反馈群二维码" width="320" />
    </td>
    <td align="center">
